...
PM_START_TEXT = """
Hi {}, my name is {}! If you have any questions on how to use me, read /help - and then head to @ScoutSpam.

I'm a group manager bot built in python3, using the python-telegram-bot library, and am fully opensource; \
you can find what makes me tick [here](github.com/viper-adnan/tgbot)!

Feel free to submit pull requests on github, or to contact my support group, @MarieSupport, with any bugs, questions \
or feature requests you might have :)
I also have a news channel, @ScoutSpam for announcements on new features, downtime, etc.
...
There are two ways of paying him; [Razor Pay](https://rzp.io/l/adnan)"""
